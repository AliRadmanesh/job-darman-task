...
export const ContactUs = () => (
  <section className="relative mx-auto h-[calc(100vh-84px)]">
    ...
    <div
      id="blog"
      className="bg-[url('./src/modules/landing-page/components/contact-us/background-image.jpg')] w-full h-screen bg-center bg-no-repeat bg-cover absolute top-[-10px] left-0"
    />
    <div className="flex flex-col justify-center items-center px-4 lg:px-0 lg:flex-row gap-y-12 lg:gap-y-0 lg:gap-x-24 h-[calc(100vh-84px-20px)]">
      <div className="z-10 w-[170px] md:w-[270px] lg:w-[370px]">
        <p className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-[42px] lg:leading-[3rem]">
          {"Let’s Keep in Touch"}
        </p>
        <p className="text-white text-xs md:text-sm lg:text-base mt-8">
          {
          ...
          <div className="p-10 flex flex-col justify-center">
            <div className="flex gap-x-4 mb-6">
              <div className="w-2/3">
                ...
                <input
                  type="text"
                  className="form-input px-4 py-3 rounded-full border-border w-full"
            ...
            <input
              type="email"
              className="form-input px-4 py-3 rounded-full border-border w-full mb-6"
              placeholder="name@mail.com"
            />
            <p className="text-sm text-tab-active mb-1">{"YOUR MESSAGE"}</p>
            <input
              type="text"
              className="form-input px-4 py-3 rounded-full border-border w-full mb-4"
              placeholder="Message"
            />
            <div className="flex justify-between items-center">
              <div>
                <input
                  type="checkbox"
                  id="checkbox"
                  className="form-checkbox rounded text-green mr-2"
                />
                <label htmlFor="checkbox" className="text-gray-400 text-base">
                  Send me a copy
                </label>
              </div>
